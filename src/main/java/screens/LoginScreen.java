...
class LoginSelectors {
    ...
    public static final By TXT_EMAIL = By.xpath("//android.widget.EditText[@content-desc=\"username\"]");
    public static final By TXT_PASSWORD = By.xpath("//android.widget.EditText[@content-desc=\"password\"]");
}
